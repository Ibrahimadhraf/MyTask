...
class Listvector5ItemWidget extends StatelessWidget {
  Listvector5ItemWidget(this.listvector5ItemModelObj);

  Listvector5ItemModel listvector5ItemModelObj;
    ...
    return Row(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            listvector5ItemModelObj.fertilizationTxt,
