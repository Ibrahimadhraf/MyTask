import '../add_plant_ten_screen/widgets/listframe5_item_widget.dart';
import '../add_plant_ten_screen/widgets/listvector12_item_widget.dart';
import 'bloc/add_plant_ten_bloc.dart';
import 'models/add_plant_ten_model.dart';
...
class AddPlantTenScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<AddPlantTenBloc>(
        create: (context) => AddPlantTenBloc(
            AddPlantTenState(addPlantTenModelObj: AddPlantTenModel()))
          ..add(AddPlantTenInitialEvent()),
        child: AddPlantTenScreen());
  }
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Row(children: [
                            BlocSelector<AddPlantTenBloc, AddPlantTenState,
                                    bool?>(
                                ...
                                builder: (context, isCheckbox) {
                                  return CustomCheckbox(
                                      ...
                                      onChange: (value) {
                                        context.read<AddPlantTenBloc>().add(
                                                            ...
                                                            .separated(
                                                                ...
                                                                itemBuilder:
                                                                  ...
                                                                  Listframe5ItemModel
                                                                      model =
                                                                      addPlantTenModelObj
                                                                              ?.listframe5ItemList[index] ??
                                                                          Listframe5ItemModel();
                                                                  return Listframe5ItemWidget(
                                                                      model);
                                                                });
                                                      }))),
                                          Padding(
                                              ...
                                              child: BlocSelector<
                                                  ...
                                                  builder: (context,
                                                    ...
                                                    return ListView.separated(
                                                        ...
                                                        itemCount:
                                                            addPlantTenModelObj
                                                                    ?.listvector12ItemList
                                                                    .length ??
                                                                0,
                                                        itemBuilder:
                                                            (context, index) {
                                                          Listvector12ItemModel
                                                              model =
                                                              addPlantTenModelObj
                                                                          ?.listvector12ItemList[
                                                                      index] ??
                                                                  Listvector12ItemModel();
                                                          return Listvector12ItemWidget(
                                                              model);
                                                        });
                                                  })),
                                          Padding(
