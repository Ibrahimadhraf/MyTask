...
class Listvector12ItemWidget extends StatelessWidget {
  Listvector12ItemWidget(this.listvector12ItemModelObj);

  Listvector12ItemModel listvector12ItemModelObj;
    ...
    return Row(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            listvector12ItemModelObj.typeTxt,
