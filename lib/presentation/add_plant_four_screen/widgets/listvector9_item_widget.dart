...
class Listvector9ItemWidget extends StatelessWidget {
  Listvector9ItemWidget(this.listvector9ItemModelObj);

  Listvector9ItemModel listvector9ItemModelObj;
    ...
    return Row(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            listvector9ItemModelObj.fertilizationTxt,
