...
import 'package:ebrahim_s_application1/presentation/settings_screen/models/settings_model.dart';
...
class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        ...
        languageoneController: TextEditingController(),
        group1000000953Controller: TextEditingController()));
  }
}
