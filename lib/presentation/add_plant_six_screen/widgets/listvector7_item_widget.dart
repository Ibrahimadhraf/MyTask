...
class Listvector7ItemWidget extends StatelessWidget {
  Listvector7ItemWidget(this.listvector7ItemModelObj);

  Listvector7ItemModel listvector7ItemModelObj;
    ...
    return Row(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            listvector7ItemModelObj.typeTxt,
