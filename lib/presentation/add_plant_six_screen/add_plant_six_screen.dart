import '../add_plant_six_screen/widgets/listframe3_item_widget.dart';
import '../add_plant_six_screen/widgets/listvector7_item_widget.dart';
import 'bloc/add_plant_six_bloc.dart';
import 'models/add_plant_six_model.dart';
...
class AddPlantSixScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<AddPlantSixBloc>(
        create: (context) => AddPlantSixBloc(
            AddPlantSixState(addPlantSixModelObj: AddPlantSixModel()))
          ..add(AddPlantSixInitialEvent()),
        child: AddPlantSixScreen());
  }
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Row(children: [
                            BlocSelector<AddPlantSixBloc, AddPlantSixState,
                                    bool?>(
                                ...
                                builder: (context, isCheckbox) {
                                  return CustomCheckbox(
                                      ...
                                      onChange: (value) {
                                        context.read<AddPlantSixBloc>().add(
                                                            ...
                                                            .separated(
                                                                ...
                                                                itemBuilder:
                                                                  ...
                                                                  Listframe3ItemModel
                                                                      model =
                                                                      addPlantSixModelObj
                                                                              ?.listframe3ItemList[index] ??
                                                                          Listframe3ItemModel();
                                                                  return Listframe3ItemWidget(
                                                                      model);
                                                                });
                                                      }))),
                                          Padding(
                                              ...
                                              child: BlocSelector<
                                                  ...
                                                  builder: (context,
                                                    ...
                                                    return ListView.separated(
                                                        ...
                                                        itemBuilder:
                                                            (context, index) {
                                                          Listvector7ItemModel
                                                              model =
                                                              addPlantSixModelObj
                                                                          ?.listvector7ItemList[
                                                                      index] ??
                                                                  Listvector7ItemModel();
                                                          return Listvector7ItemWidget(
                                                              model);
                                                        });
                                                  })),
                                          Padding(
