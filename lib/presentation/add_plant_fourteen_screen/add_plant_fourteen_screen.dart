import '../add_plant_fourteen_screen/widgets/listframe2_item_widget.dart';
import '../add_plant_fourteen_screen/widgets/listvector4_item_widget.dart';
import 'bloc/add_plant_fourteen_bloc.dart';
import 'models/add_plant_fourteen_model.dart';
...
class AddPlantFourteenScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<AddPlantFourteenBloc>(
        create: (context) => AddPlantFourteenBloc(AddPlantFourteenState(
            addPlantFourteenModelObj: AddPlantFourteenModel()))
          ..add(AddPlantFourteenInitialEvent()),
        child: AddPlantFourteenScreen());
  }
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Row(children: [
                            BlocSelector<AddPlantFourteenBloc,
                                    AddPlantFourteenState, bool?>(
                                                      ...
                                                      builder: (context,
                                                        ...
                                                        return ListView
                                                            .separated(
                                                                ...
                                                                itemCount: addPlantFourteenModelObj
                                                                        ?.listframe2ItemList
                                                                        .length ??
                                                                    0,
                                                                itemBuilder:
                                                                  ...
                                                                  Listframe2ItemModel
                                                                      model =
                                                                      addPlantFourteenModelObj
                                                                              ?.listframe2ItemList[index] ??
                                                                          Listframe2ItemModel();
                                                                  return Listframe2ItemWidget(
                                                                      model);
                                                                });
                                                      }))),
                                          Padding(
