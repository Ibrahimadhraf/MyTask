...
class Listvector14ItemWidget extends StatelessWidget {
  Listvector14ItemWidget(this.listvector14ItemModelObj);

  Listvector14ItemModel listvector14ItemModelObj;
    ...
    return Row(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            listvector14ItemModelObj.typeTxt,
